<template>
  <div class="price-container">
    <div class="t-top-bar">
      ...
      <i class="el-icon-circle-plus-outline l-add-buttion" v-if="authedCheck('添加计价规则')" title="添加计价规则"
         @click="addHandler"></i>
    </div>
    <el-table :data="tableData" border style="width: 100%" v-loading="listLoading">
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <i class="el-icon-edit el-icon-table" v-if="authedCheck('编辑计价规则')" title="编辑计价规则"
