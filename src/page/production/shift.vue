<template>
  <div class="shift-container">
    ...
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column prop="date" label="班次编号" width="80"></el-table-column>
    ...
    <el-dialog title="添加班次" :visible.sync="addDialogVisiable" width="650px">
      <el-form :model="addForm">
        <el-form-item label="班次编号" :label-width="formLabelWidth">
